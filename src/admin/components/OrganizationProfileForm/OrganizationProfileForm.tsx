      ...
      <div className="file-wrapper">
        ...
        <div>
          ...
          />
                ...
                <Formik initialValues={initialValues} onSubmit={handleProfileForm}
                        validationSchema={OrganizerFormValidationSchema} enableReinitialize={true}>
                    {(form) => (
                ...
                /> */}
                            ...
                            <div className="attributes-wrapper">
                                <LabelWithTag label="Organization Attributes"
                                ...
                                <div className="socialMedia-wrapper">
                                    ...
                                    <div className="socialLinks-wrapper">
                                        ...
                                        <InputBox name="instagram"
                                                  ...
                                                  label="Instagram"/>
                                        <InputBox name="twitter" placeholder="e.g. https://www.twitter.com/"
                                                  label="Twitter"/>
                                        <InputBox name="youtube" label="Youtube"
                                                  placeholder="e.g. https://www.youtube.com/organizer"/>
                                    </div>
                                    <input type="submit" value="Submit" ref={submitRef} style={{display: "none"}}
                                           onClick={() => {
                                           }}/>
                                </div>
                            </div>
