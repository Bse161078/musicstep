...
export default function HowItWorks() {
    ...
    const content=<>
        ...
        <p className="description"><span style={{fontWeight:"bold"}}>Timmy</span> is a Music Dip member (6 credits), and decides to use his membership as follows:</p>
        <p className="description-without-margin" style={{marginLeft:20}}>1 – Rock concert (6 credits) :</p>
        <p className="description"><span style={{fontWeight:"bold"}}>Jen</span> is a Music Lite member (23 credits), and decides to use her membership as follows:</p>
        <p className="description-without-margin" style={{marginLeft:20}}>1 – Rock concert (6 credits)</p>
        <p className="description-without-margin" style={{marginLeft:20}}>1 – Rock concert (6 credits)</p>
        <p className="description-without-margin" style={{marginLeft:20}}>1 – Club night (13 credits)</p>
        <p className="description"><span style={{fontWeight:"bold"}}>Carlos</span> is a Music Enthusiast member (48 credits), and decides to use his membership as follows:</p>
        ...
        <p className="description"><span style={{fontWeight:"bold"}}>Monique</span> is a Music Fan member (68 credits), and decides to use her membership as follows:</p>
        ...
        <p className="description"><span style={{fontWeight:"bold"}}>Ricky</span> is a Music Pro member (99 credits), and decides to use his membership as follows:</p>
