...
export default function Reservation() {
    ...
    const content=<>
        ...
        <p className="description-without-margin">If an event was cancelled and you were not informed, please contact us here, so we can rectify the situation and ensure any credits used towards the reservation are returned to you as soon as possible.</p>
