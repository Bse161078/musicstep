    ...
    const handleFilter = (value: any) => {
        ...
        if (field.name === 'categoriesType' || field.name === 'genre') {
            ...
            data = [
                {
                    type: "distance",
                    search: [{location: {latitude: latitude, longitude: longtitude}, value: parseInt(value.split(" "))}]
                },
        ...
        <SelectInputStyle type={type}>
            ...
            { filteredValues && filteredValues.length>0 &&
                <SelectBoxStyle
                    ...
                    name="location"
                    width={width}
                    defaultValue={filteredValues && filteredValues[0]}
                    // value={val}
                ...
                >
                    ...
                    {filteredValues && filteredValues.map(
                        (option: any) => (
                            <Option
                                key={option}
                                value={option}
